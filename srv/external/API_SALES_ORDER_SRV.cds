/* checksum : eb1b1c0f02038589b976168014d62304 */
@cds.external : true
...
service API_SALES_ORDER_SRV {
  ...
  entity A_SalesOrder {
    ...
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    SalesOrderTypeInternalCode : String(4);
    @sap.display.format : 'UpperCase'
    ...
    @sap.label : 'Customer Reference (Ship-to Party)'
    ...
    @sap.quickinfo : 'Category of Reference Document'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.quickinfo : 'Customer Account Assignment Group'
    ...
    @sap.label : 'Relevant for Proof of Delivery'
    ...
    @sap.display.format : 'UpperCase'
    @sap.label : 'Tax Departure Country/Region'
    TaxDepartureCountry : String(3);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Tax Destination Country/Region'
    @sap.quickinfo : 'Destination Country/Region for Tax Determination'
  ...
  entity A_SalesOrderHeaderPrElement {
    ...
    @sap.display.format : 'Date'
    @sap.label : 'Condition Pricing Date'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    ...
    @sap.unit : 'TransactionCurrency'
    @sap.label : 'Condition Rounding Difference'
    @sap.quickinfo : 'Rounding-Off Difference of a Condition'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
  ...
  entity A_SalesOrderItmPrecdgProcFlow {
    ...
    @sap.quickinfo : 'SD Document Category of Reference SD Document'
